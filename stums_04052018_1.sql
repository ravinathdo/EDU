...
insert  into `course_subject`(`course_id`,`year_semester`,`subject_id`,`lecture_id`,`course_subject_id`) values (1,'Year1-semester1',4,1,1),(1,'Year3-semester1',4,2,2),(2,'Year1-semester1',2,8,8),(5,'Year1-semester1',1,1,3),(5,'Year1-semester2',8,7,5);
...
insert  into `lecture_schedule`(`id`,`course_subject_id`,`schedule_title`,`course_id`,`schedule_date`,`from_time`,`to_time`,`lacture_id`,`createdtime`) values (5,8,'lecturre 2',2,'2018-05-25','10:11','12:11',17,'2018-05-04 11:57:35'),(6,8,'Lecture 3',2,'2018-05-24','10:11','12:12',17,'2018-05-04 11:58:02'),(7,8,'Time Table 3',2,'2018-05-18','04:44','11:05',17,'2018-05-04 11:59:05'),(8,8,'Lecture 3',2,'2018-05-24','12:12','12:12',17,'2018-05-04 12:01:26'),(9,8,'Lecture 3',2,'2018-05-25','12:12','12:12',17,'2018-05-04 12:02:47');
...
insert  into `student_batch`(`id`,`student_id`,`batch_id`,`student_batch`,`datecreated`) values (1,1,6,16,'2018-04-17 10:52:22'),(3,4,6,46,'2018-04-17 10:52:38'),(7,10,6,106,'2018-04-17 11:35:25'),(8,9,5,95,'2018-05-04 12:00:56');
