            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">Lecture Slides Upload</div>
                        <div class="panel-body">
                            ...
                            <form action="upload.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-2 control-label">Slide Title <span class="mando-msg">*</span></label>
                                    <div class="col-sm-10">
                                        <input type="text" required="" name="slide_title" class="form-control" id="inputEmail3">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputPassword3" class="col-sm-2 control-label">Upload Slide</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-10">
                                        <button type="submit" class="btn btn-warning">Upload Lecture Slides</button>
                                    </div>
                                </div>
                            </form>
