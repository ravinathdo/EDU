...
<html lang="zxx">
  ...
  <!--services-->
        ...
        <!--//agileits-services-->
            <?php
        } else if (isset($_SESSION['ssn_lecturer'])) {
            //lecturer 
            ?>
            ...
            <div class="container">
                ...
                <div class="agileits-services-row">
                    <div class="col-md-3 col-sm-6 agileits-services-grids">
                        <span class="glyphicon glyphicon-stats effect-1" aria-hidden="true"></span>
                        <h4>Reports</h4>
                        <p> System Report Utility to collect internal system log files, relevant registry entries, event logs</p>
                    </div>
                    <div class="col-md-3 col-sm-6 agileits-services-grids">
                        <span class="glyphicon glyphicon-user effect-1" aria-hidden="true"></span>
                        <h4>Students</h4>
